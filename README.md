...
Every image below is **real output** — no mockups. All are rewound to
**2024-10-31 06:00**, six hours before machine 51's recorded failure, and all
are regenerated by committed scripts rather than trusted.

**Fleet overview** — 100 machines scored, 2 alerting, sorted most urgent first.

![Fleet overview: 100 machines scored at 2024-10-31 06:00, two of them critical](docs/images/dashboard-fleet.png)

**Machine detail** — the prediction next to the sensor evidence behind it.

![Machine 51 detail: critical, P(failure ≤24h) 1.0000, with the sensor evidence table](docs/images/dashboard-machine.png)

**AI report** — written by a local model from that evidence and nothing else;
every figure it quotes traces back to the table above.

![AI maintenance report for machine 51, generated by a local qwen2.5-coder model](docs/images/dashboard-report.png)
...
A demo GIF is still missing — [`docs/images/README.md`](docs/images/README.md)
