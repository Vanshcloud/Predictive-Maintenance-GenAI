...
`docs/images/` holds the horizon chart, which is generated by a committed
script. Dashboard screenshots and a demo GIF are placeholders — see
[`images/README.md`](images/README.md) for how to produce them.
