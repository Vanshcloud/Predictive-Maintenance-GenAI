...
| **Dependencies** | M8. |
| **Effort** | 1 day. |
| **Success criteria** | `/docs` renders; p95 `/predict` < 500 ms; malformed input returns 422, never 500. |
...
| **Dependencies** | M11. |
| **Effort** | 1 day. |
| **Success criteria** | A stranger can clone, follow the README, and reach a working dashboard. |
